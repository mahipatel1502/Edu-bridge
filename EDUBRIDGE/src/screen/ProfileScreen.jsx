...
const ProfileScreen = ({ route }) => {
  ...
  const checkFollowStatus = async () => {
    ...
    try {
      ...
      const followResponse = await fetch(`http://192.168.215.205:5000/check-follow?senderEmail=${senderEmail}&receiverEmail=${email}`);
      ...
      const requestResponse = await fetch(`http://192.168.215.205:5000/check-request?senderEmail=${senderEmail}&receiverEmail=${email}`);
